...
func NewWebhookActivationLogEntry(integrationRequestUuid string, webhookId int32, applicationId int32, campaignId int32, created time.Time) *WebhookActivationLogEntry {
	this := WebhookActivationLogEntry{}
...
func (o WebhookActivationLogEntry) MarshalJSON() ([]byte, error) {
...
func (v NullableWebhookActivationLogEntry) Get() *WebhookActivationLogEntry {
	return v.value
}

func (v *NullableWebhookActivationLogEntry) Set(val *WebhookActivationLogEntry) {
	v.value = val
	v.isSet = true
}

func (v NullableWebhookActivationLogEntry) IsSet() bool {
	return v.isSet
}

func (v *NullableWebhookActivationLogEntry) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebhookActivationLogEntry(val *WebhookActivationLogEntry) *NullableWebhookActivationLogEntry {
	return &NullableWebhookActivationLogEntry{value: val, isSet: true}
}
